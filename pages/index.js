...
export default function Home() {
  ...
  let [color, setColor] = useState("#6930c3");
      ...
      <div className={styles.hero}>
        ...
        <div className={styles.content} ref={wrapper}>
          <div className={styles.left}>
            <div className={styles.bigText} ref={text}>I create beautiful websites with my hands and a computer <Image width="32" height="32" alt="computer" src={Computer}/></div>
            <div ref={button} className={styles.buttonWrapper}>
          ...
          <div className={styles.changeColor}>
            ...
            <input type="color" id="mainColor" value={color} onChange={changeColor}/>
          </div>
        </div>
      </div>
